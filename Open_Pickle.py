...
if __name__ == "__main__":
    # setting a path
    path = 'D:\\Python\\Programme\\Physics-Capacitor-Simualtion\\resources\\exports\\01_01_2021__15_06_19_Test_0_032_d_16_nbins_32_9_70_lines_new_density_NEW_TEST'
    ...
    # cap.plot_field_lines(num_field_lines=70, delta_m=0.000004 * 20, x_plane=[0.015])
    # cap.analysis_2d_profile(resolution_x=200, resolution_y=200, size=1.5, small_fraction=1000, images_n=50)
    # cap = Plate_Capacitor(n_neg=6, n_pos=6, p1=[0.01, 0.01], p2=[0.02, 0.02], plane_z_pos=[0.001],
    #                       plane_z_neg=[0.005],
    #                       random=False, name='Test')
    # # cap.plotting_plates()
    cap.plate_neg.plot_density_self_made(nbins_inside=75, searching_box=13)
    ...
    # z_planes = np.linspace(cap.plate_pos.z_plane + cap.z_plane_diff / 2,cap.plate_neg.z_plane - (1 / 100000), 25)
    ...
    cap.plot_field_lines_integral_calculation_flatten(num_field_lines=85, x_plane=[0.015], nbins=75, searching_box=13,
                                                      delta_m=0.000004 * 20)
    ...
    # print(x)
    # ar = cap.plot_field_lines_integral_calculation(num_field_lines=100, delta_m=0.000004*20, nbins=32, x_plane=[0.015],
