...
if __name__ == "__main__":
    # setting a path
    path = 'D:\\Python\\Programme\\Physics-Capacitor-Simualtion\\resources\\exports\\01_01_2021__15_06_19_Test_0_032_d_16_nbins_30_new_density'
    ...
    # cap.plate_neg.plot_density_self_made(nbins_inside=32, searching_box=9)
    cap.plot_field_lines_integral_calculation_flatten(num_field_lines=50, x_plane=[0.015], nbins=32,
                                                      delta_m=0.000004 * 28)
