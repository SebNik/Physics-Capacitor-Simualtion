...
if __name__ == "__main__":
    # setting a path
    path = 'D:\\Python\\Programme\\Physics-Capacitor-Simualtion\\resources\\exports\\01_01_2021__15_06_19_Test_0_032_d_16_field_lines_integral'
    ...
    # cap = Plate_Capacitor(n_neg=5, n_pos=5, p1=[0.01, 0.01], p2=[0.02, 0.02], plane_z_pos=[0.001],
    #                       plane_z_neg=[0.005],
    ...
    # print(x)
    ar = cap.plot_field_lines_integral_calculation(num_field_lines=70, delta_m=0.000004, nbins=32, x_plane=[0.015],
