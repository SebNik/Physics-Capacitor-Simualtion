...
if __name__ == "__main__":
    ...
    cap.plate_neg.move_plane_on_z_plane(new_z_plane=0.0055)
    x = np.linspace(0.0001, cap.plate_neg.x_length - 0.0001, 4) + cap.p1[0]
    ar = cap.plot_field_lines(x_plane=x, num_field_lines=13)
